/**
 * Script to import the Hello World Test project JSON into the database
 * Run with: npx electron scripts/import-hello-world.js
 */
...
async function importProject() {
  console.log('Starting Hello World Test project import...');

  // Read the JSON file
  const jsonPath = path.join(__dirname, '../docs/hello-world-test_kanban.json');
  ...
  try {
    ...
    if (existingProject) {
      ...
      console.log('Deleting existing project to re-import...');
...
importProject().catch(console.error);
